...
for i in range(23):
    param_1.append(z3.BitVec(f'flag{i}', 8))

    # the solution must be composed by valid ascii characters
    s.add(param_1[i] >= 0x20)
    s.add(param_1[i] <= 0x7e)

s.add(param_1[0] == ord('f'))
s.add(param_1[1] == ord('l'))
s.add(param_1[2] == ord('a'))
s.add(param_1[3] == ord('g'))
s.add(param_1[4] == ord('{'))
s.add(param_1[22] == ord('}'))
...
s.add(
    ...
    param_1[2] * 0x57 + param_1[0x13] * -0x8d +
    param_1[0x16] * -0xba + param_1[0xf] * 0xa9
    + param_1[0x10] * -0x14 + param_1[5] * 0x52 +
    param_1[0x11] * -0x23 + param_1[1] * -0x68
    + param_1[0x15] * 199 + param_1[0x12] * 0x57 +
    param_1[0xd] * 0xeb + param_1[8] * -0xa8
...
s.add(
    ...
    param_1[0x11] * -0xb5 + param_1[0xe] * -0x14 +
    param_1[7] * 0xea + param_1[10] * -0xc3
    + param_1[8] * 0xeb + param_1[0xf] * 0xba + param_1[0x10] * -0xf5 +
    param_1[0x15] * 0xe7 + param_1[0xc] * 0x97 +
    param_1[0x16] * 0x97 + param_1[6] * -0x4e == 0
)
...
s.add(
    ...
    param_1[0x15] * -0x89 + param_1[9] * -0xba +
    param_1[7] * 0x53 + param_1[0xb] * 0x6e
    + param_1[2] * 0x8e + param_1[5] * -0xe5 +
    param_1[0xd] * 0xc5 + param_1[0x10] * -7
    + param_1[0x16] * -0xee + param_1[0] *
    0xed + param_1[0xe] * 0xab + -0x3da5 == 0
)
...
s.add(
    ...
    param_1[0xd] * -0xe7 + param_1[9] * 0x7a +
    param_1[0] * -0x42 + param_1[1] * 0xca
...
s.add(
    ...
    param_1[0x14] * 0xf9 + param_1[3] *
    0xd3 + -0x130f0 + param_1[0x11] * -0xfc
...
s.add(
    ...
    param_1[9] * 0x86 + param_1[0x12] * -
    0x65 + -0x53c7 + param_1[1] * -0x48
